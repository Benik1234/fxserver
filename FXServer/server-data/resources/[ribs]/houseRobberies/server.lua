...
local robbableItems = {
 ...
 [13] = {chance = 10, id = 'disc_ammo_pistol', name = 'Weapon Clip', quantity = 1}, -- rare
 [14] = {chance = 10, id = 'coke', name = 'Cocaine', quantity = 3}, -- common
 [15] = {chance = 9, id = 'goldNecklace', name = 'Gold Necklace', quantity = 1}, -- rare
 [16] = {chance = 8, id = 'diamond', name = 'diamond', quantity = 1}, -- rare
 ...
 [20] = {chance = 8, id = 'carokit', name = 'Body kit', quantity = math.random(1, 5)}, -- common
 [21] = {chance = 8, id = 'lowradio', name = 'Stock Radio', quantity = 2},
 [22] = {chance = 8, id = 'gold', name = 'gold', quantity = 2}, 
 ...
 [27] = {chance = 8, id = 'rolex', name = 'Rolex', quantity = math.random(1, 5)}, 
 [28] = {chance = 9, id = 'fixkit', name = 'fixkit', quantity = 1},
 [29] = {chance = 8, id = 'samsungS10', name = 'Samsung Phone', quantity = 2}, 
 [30] = {chance = 9, id = 'spice', name = 'Bag of spice', quantity = 2}, 
 [31] = {chance = 8, id = 'copper', name = 'copper', quantity = 1},
 ...
 [34] = {chance = 8, id = 'keycard', name = 'Keycard', quantity = 1},
